...
<br />
<p>
  I hope this tutorial helped you learn a little bit about network security protocols and observe traffic between virtual machines. This can be easily done on a PC (desktop) or a Mac. Note: On Mac, you will have an extra step to download the Remote Desktop App from AppStore.
</p>
<p>
